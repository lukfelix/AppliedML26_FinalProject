...
The project restrictions can be found [here](https://www.nbi.dk/~petersen/Teaching/ML2026/FinalProject.html).

All necessary packages can be installed with the [requirements.txt on the course page](https://www.nbi.dk/~petersen/Teaching/ML2026/requirements.txt)
